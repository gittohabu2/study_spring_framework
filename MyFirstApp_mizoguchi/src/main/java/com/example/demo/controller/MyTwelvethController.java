...
public class MyTwelvethController {
	...
	public String twelveget(Model model,HttpSession session) {
	...
	public String twelvethpost(Model model,HttpSession session,String text1) {
		
		model.addAttribute("inputData",text1);
		session.setAttribute("sessionData2", text1);
