...
public class MyDbThirdPraController {
	...
	public String dbspser(Model model,String itemname) {
		...
		kensakukekka = jdbcTemplate.queryForList("SELECT * FROM thirdtable WHERE itemname = ?", itemname);
		//検索結果のリストをmodelに格納する。
	...
	public String dbspIns(Model model,String itemname,String itemprice) {
		...
		// データ更新
		jdbcTemplate.update("INSERT INTO thirdtable VALUES(?,?)", itemname, itemprice);
